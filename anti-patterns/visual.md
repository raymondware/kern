---
file: anti-patterns/visual.md
tags: [color, gradient, layout, typography, dark-mode, icons, shadow, animation]
affects: all
...
## Gradient Slop
_Tags: color, gradient, hero, background · Affects: all · Severity: high_
...
## Nested Card Soup
_Tags: layout, shadow, depth, cards · Affects: all · Severity: medium_
...
_Tags: color, dark-mode, contrast, background · Affects: all · Severity: medium_
...
_Tags: typography, fonts, ai-tell · Affects: all · Severity: low_
...
_Tags: hero, layout, gradient, color, ai-tell · Affects: developer-tool, consumer-saas, b2b-enterprise · Severity: high_
...
## Stock Icon Sets
_Tags: icons, visual-quality · Affects: all · Severity: low_
...
_Tags: color, palette, ai-tell · Affects: all · Severity: medium_
...
_Tags: shadow, depth, layout · Affects: all · Severity: medium_
...
_Tags: dark-mode, color, contrast · Affects: all · Severity: high_
...
_Tags: color, neon, brand · Affects: developer-tool, b2b-enterprise, consumer-saas · Severity: medium_
