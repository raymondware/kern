...
Step 4 - Self-score:
  ...
  If self-score >= 70 on pass 1: revise Step 3 (change at least 3 elements) and re-score.
  If self-score >= 70 on pass 2: proceed with best attempt and include this warning in output:
    "Score remains {n}/100 after 2 revision passes, proceeding with best attempt."
...
2. It scores 0-100 using the Sameness Score rubric from `agents/design-critic.md` with no access to the kern-runner's reasoning.
...
Score it 0-100 on how much it resembles default AI design tool output, using this rubric:

  0-20: Distinctive, with at least 3 unusual persona-specific decisions, would not be identified as AI-generated
  21-40: Mostly distinctive, with 1-2 AI-default elements
  41-60: Neutral, with no strong point of view but avoids obvious tells
  61-80: Recognizably AI, with multiple default patterns present
  81-100: Default AI output, such as purple gradient, centered hero, Inter, card grid

Sameness indicators (each +10 to score):
