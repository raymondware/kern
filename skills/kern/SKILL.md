...
| `critique-synthesizer` | Sonnet | Merges parallel critic outputs, deduplicates, computes consensus sameness score. |
...
| Agent | Model | Role |
|---|---|---|
| `design-critic` | Sonnet | Broad anti-pattern scan; per-dimension score capped at 40 |
...
| `copy-editor` | Sonnet | Headline and marketing copy slice |
